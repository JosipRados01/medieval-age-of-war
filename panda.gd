...
func die():
	Singleton.add_points(team, "panda")
...
func _on_animated_sprite_2d_frame_changed() -> void:
	if animated_sprite.animation == "attack" :
		hurtbox.disabled = !(animated_sprite.frame == 5 or animated_sprite.frame == 7 or animated_sprite.frame == 9)
